...
/**
 * Created by Fareeha on 2/12/2018.    Random_Profile_Adapter madapter;
 */

public class Popular_Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    Session session;
    RecyclerView mrecyclerview;
    Random_Profile_Adapter madapter;
    Boolean login;
    ArrayList<Data> data,popular_data,arrayList;
    DrawerLayout drawer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.popular_main_layout);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        session = new Session(Popular_Activity.this);
        ...
        LinearLayoutManager linearLayoutManager= new LinearLayoutManager(Popular_Activity.this,LinearLayoutManager.VERTICAL,false);
        getPopularData();
...
// Drawer Part
        ...
        navigationView.setNavigationItemSelectedListener(Popular_Activity.this);
        // Navigation Header
       ...
       Picasso.with(this).load(arrayList.get(0).getPic()).into(Ad_Img);
        ...
        drawer_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Popular_Activity.this,ProfileActivity.class));
            }
        });
    ...
    public  void getPopularData()
    {
        ...
        String popular_ul=   "api/v1/popular/?api_token="+api_token;;
        ...
        call.enqueue(new Callback<RootObject>() {
            ...
            public void onResponse(Call<RootObject> call, Response<RootObject> response) {
                try {
                    ...
                    popular_data= (ArrayList<Data>) object.getDataarray();
                   madapter=new Random_Profile_Adapter(Popular_Activity.this,R.layout.item_post,data,1);
mrecyclerview.setAdapter(madapter);
                }catch (Exception e) {
            ...
            public void onFailure(Call<RootObject> call, Throwable t) {
                ...
                Toast.makeText(Popular_Activity.this,t.toString(),Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void clickPopupar(View view)
    {
            ...
            if(data!=null) {
              ...
              /*  Intent intent=new Intent(Popular_Activity.this, Popular_Activity.class);
...
*/
    ...
    public void clickHome(View view)
    {
        ...
        startActivity(new Intent(Popular_Activity.this, MainActivity.class));
    ...
    public void clickLatest(View view)
    {
        ...
        Intent intent = new Intent(Popular_Activity.this, Latest_Activity.class);
        intent.putExtra("data", data);
        intent.putExtra("data1", arrayList);
        startActivity(intent);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent leader= new Intent(Popular_Activity.this,MainActivity.class);
        ...
        {
            Intent leader= new Intent(Popular_Activity.this,LeaderActivity.class);
        ...
        if (id == R.id.nav_camera) {
            login = session.isLoggedIn();
            if(login==true) {
                startActivity(new Intent(Popular_Activity.this, CustomGallery_Activity.class));
                //Intent intent = new Intent(MainActivity.this, Upload_Iimage.class);
                // startActivity(intent);
            }
            else
            {
                Intent intent = new Intent(Popular_Activity.this, ProfileActivity.class);
                startActivity(intent);
            }
        ...
        else if(id==R.id.nav_games)
        {
            login = session.isLoggedIn();
            if(login==true) {
                Intent leader= new Intent(Popular_Activity.this,Encounter.class);
            ...
            {
                Intent leader= new Intent(Popular_Activity.this,Registration_Activity.class);
            ...
            login = session.isLoggedIn();
            if(login==true) {
                Intent leader= new Intent(Popular_Activity.this,ProfileActivity.class);


                Bundle bndlanimation = ActivityOptions.makeCustomAnimation(getApplicationContext(), R.anim.animation1,R.anim.animation2).toBundle();
                leader.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(leader,bndlanimation);
            }
            else
            {
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Popular_Activity.this, MainActivity.class);
